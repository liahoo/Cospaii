...
object Menu {
    ...
    val categories = arrayOf(
        MenuItem(R.getString("PC"), "/pc", null, arrayOf(
            ...
            MenuItem(R.getString("Tablet"), "/pc/Tablet", null, arrayOf(
        ...
        MenuItem(R.getString("Clothes"), "/Clothes", null, arrayOf(
            MenuItem(R.getString("Mens"), "/Clothes/Mens", null, arrayOf(
            ...
            MenuItem(R.getString("Ladies"), "/Clothes/Ladies", null, arrayOf(
            ...
            MenuItem(R.getString("Kids"), "/Clothes/Kids", null, arrayOf(
    ...
    val mainMenu = arrayOf(
        ...
        MenuItem(R.getString("On Sale"), "/Sale", null, arrayOf(
            MenuItem(R.getString("Electronics"), "/Hot/Electronics/", null, arrayOf(
                MenuItem(R.getString("Phone"), "/pc/note/cables"),
                MenuItem(R.getString("Tablet"), "/pc/note/cables"),
                MenuItem(R.getString("Power"), "/pc/note/cpu"),
                MenuItem(R.getString("SSD"), "/pc/note/cpu")
            )),
            MenuItem(R.getString("Clothes"), "/Popular/Clothes/", null, arrayOf(
        ...
        MenuItem(R.getString("New Products"), "/Sale", null, arrayOf(
            MenuItem(R.getString("Electronics"), "/Hot/Electronics/", null, arrayOf(
        ...
        MenuItem(R.getString("Hot Products"), "/Hot", null, arrayOf(
            MenuItem(R.getString("Electronics"), "/Hot/Electronics/", null, arrayOf(
                MenuItem(R.getString("Phone"), "/Hot/Electronics/Phone"),
                MenuItem(R.getString("Tablet"), "/Hot/Electronics/Tablet"),
                MenuItem(R.getString("Laptop"), "/Hot/Electronics/Power"),
