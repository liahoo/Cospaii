...
object Menu {
    ...
    val categories = arrayListOf(
        MenuItem(
            R.getString("PC"), "/pc", null, arrayListOf(
            MenuItem(
                R.getString("Note PC"), "/pc/note", null, arrayListOf(
            ...
            MenuItem(
                R.getString("Desktop"), "/pc/desktop", null, arrayListOf(
            ...
            MenuItem(
                R.getString("Tablet"), "/pc/Tablet", null, arrayListOf(
        ...
        MenuItem(
            R.getString("Clothes"), "/Clothes", null, arrayListOf(
            MenuItem(
                R.getString("Mens"), "/Clothes/Mens", null, arrayListOf(
            ...
            MenuItem(
                R.getString("Ladies"), "/Clothes/Ladies", null, arrayListOf(
            ...
            MenuItem(
                R.getString("Kids"), "/Clothes/Kids", null, arrayListOf(
    ...
    val mainMenu = arrayListOf(
        ...
        MenuItem(
            R.getString("On Sale"), "/Sale", null, arrayListOf(
            MenuItem(
                R.getString("Electronics"), "/Hot/Electronics/", null, arrayListOf(
            ...
            MenuItem(
                R.getString("Clothes"), "/Popular/Clothes/", null, arrayListOf(
        ...
        MenuItem(
            R.getString("New Products"), "/Sale", null, arrayListOf(
            MenuItem(
                R.getString("Electronics"), "/Hot/Electronics/", null, arrayListOf(
        ...
        MenuItem(
            R.getString("Hot Products"), "/Hot", null, arrayListOf(
            MenuItem(
                R.getString("Electronics"), "/Hot/Electronics/", null, arrayListOf(
                MenuItem(R.getString("Phone"), "/Hot/Electronics/Phone"),
                MenuItem(R.getString("Tablet"), "/Hot/Electronics/Tablet"),
